...
```sh
$ cd src/apis/analyticshub
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/analyticshub.min.js`. Use it from your HTML file:

```html
<script src="/path/to/analyticshub.min.js"></script>
<script>
const { analyticshub, auth } = Analyticshub;
</script>
```
